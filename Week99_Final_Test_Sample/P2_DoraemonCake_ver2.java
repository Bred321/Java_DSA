...
public class P2_DoraemonCake_ver2{
    public static void main(String[] args){
        ...
        P2_DoraemonCake_ver2 p2_DoraemonCake = new P2_DoraemonCake_ver2(topics, A);
    ...
    public P2_DoraemonCake_ver2(Topic[] topics, double A){
        this.topics = topics;
        this.A = A;
    }
